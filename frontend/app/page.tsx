...
export default function Page() {
  ...
  const isPlantRule =
    edgeActive && (rule === "plant_bias" || rule === "plant_catchup" || rule === "energy_trim" || rule === "overlay_guard");
    ...
    <main className="min-h-screen p-6 bg-[#0A0F14] text-white">
      <div className="mx-auto max-w-[1440px] space-y-6">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          {/* Right: Energy + single EDGE Analytics chip + rotating Thought Line */}
          <aside className="col-span-12 md:col-span-3 space-y-3">
            ...
            {/* Keep ONLY the original EDGE ANALYTICS chip */}
            ...
            >
              <ThoughtLine
                // map to minimal shape (id/text/tone)
        ...
        {/* Only the meter (no duplicate header) */}
        <Timeline30
          day={status?.sol ?? 0}
          tod={effTod ?? 0}
          illum={illumSegs}
